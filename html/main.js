	...
	window.addEventListener('message', function(event) {
		...
		if (event.data.action == "setTalking"){
            ...
            if(event.data.status){
                $('#engine').css('background-image','url(https://cdn.discordapp.com/attachments/788240573382787114/835863078277087283/engine.png)');
            }else{
                $('#engine').css('background-image','url(https://cdn.discordapp.com/attachments/788240573382787114/835866728630190120/off.png)');
            }
		} else if (event.data.action == "lockSwitch"){
            if(event.data.status){
                $('#lock').css('background-image','url(https://cdn.discordapp.com/attachments/788240573382787114/835863196207677480/lock-open-solid_1.png)');
            }else{
                $('#lock').css('background-image','url(https://cdn.discordapp.com/attachments/788240573382787114/835866764465668106/locl-off.png)');
            }
		}else if (event.data.action == "toggleAllHud"){
